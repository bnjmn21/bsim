import { Iter, blocks, blocksExact, blocksFill, collect, flat, iterify, join, map, mapIter, pairsExact, takeWhile } from "./itertools.js";
 ...
 */
export function b64Encode(array: Uint8Array): string {
...
export function b64Decode(b64: string): Uint8Array {
    ...
    const blocksOf4: Iter<Iter<number>> = map(blocksExact(iter, 4), v => {
    ...
    return new Uint8Array(flat<number>(blocksOf4));
}
